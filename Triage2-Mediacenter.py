...
class Item_to_process:
    ...
    def move_file(self, titre, type, season_episode=None, movie_year=None, genre=None):
        ...
        if self.type == 'Serie':
            ...
            series_pathto_folder = os.path.join("/media/julien/Triage/Series/", titre, seasons_folder)
        ...
        if self.type == 'Film':
            ...
            movies_pathto_folder = "/media/julien/Triage/Films/" + genre if genre else "Other"
    ...
    def scp_to_mediacenter(self, source, destination, destination_folder):
        ...
        while scp_success != True:
            ...
            message = subprocess.run(["ssh", "julien@mediacenter", "ls", destination_folder])
            ...
            if message.returncode != 0:
                ...
                message = subprocess.run(["ssh", "julien@mediacenter", "ls", destination_folder_up])
    ...
    def ssh_mkdir(self, path):
        message = subprocess.run(["ssh", "julien@mediacenter", "mkdir", path])
...
source = '/media/julien/Triage/'
mediacenter_destination = 'julien@mediacenter:/media/julien/Triage/'
